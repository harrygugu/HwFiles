...
chessboard_size = (9, 6)  # Number of inside corners in the chessboard pattern
square_size = 1.7         # Size of a square in your defined unit (e.g., cm)
...
images = glob.glob('data/1m/*.jpg')  # Replace with the path to your images
